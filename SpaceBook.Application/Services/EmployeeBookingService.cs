                    ...
                    <td style="padding: 16px 20px;">
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <td style="padding: 6px 10px; color: #0f172a;">{reason}</td>
                            </tr>
                    ...
                    <td style="padding: 16px 20px;">
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <td style="padding: 6px 10px; color: #0f172a;">{employeeName}</td>
                            </tr>
                ...
                <tr>
                    <td style="padding: 16px 20px;">
                        ...
                        <table
                            ...
                            <tr>
                                <td style="padding: 6px 10px; color: #64748b;"><strong>New Date:</strong></td>
                                <td style="padding: 6px 10px; color: #0f172a;">{request.BookingDate:MMMM dd, yyyy}</td>
                            </tr>

                            <tr>
                                <td style="padding: 6px 10px; color: #64748b;"><strong>New Start Time:</strong></td>
                                <td style="padding: 6px 10px; color: #0f172a;">{FormatTime(request.StartTime)}</td>
                            </tr>

                            <tr>
                                <td style="padding: 6px 10px; color: #64748b;"><strong>New End Time:</strong></td>
                                <td style="padding: 6px 10px; color: #0f172a;">{FormatTime(request.EndTime)}</td>
                            </tr>

                            <tr>
                                <td style="padding: 6px 10px; color: #64748b;"><strong>Participants:</strong></td>
                                <td style="padding: 6px 10px; color: #0f172a;">{request.ParticipantCount}</td>
                            </tr>
