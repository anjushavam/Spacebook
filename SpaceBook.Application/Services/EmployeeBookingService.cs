...
public class EmployeeBookingService : IEmployeeBookingService
{
        ...
        CreateBookingRequestDto request)
    {
        ...
        if (IsWeekend(request.BookingDate))
        {
            throw new Exception(
        ...
        UpdateBookingRequestDto request)
    {
        ...
        {
            throw new Exception(
                "Bookings cannot be scheduled on Saturdays and Sundays.");
        }
            ...
            SearchRoomsRequestDto request)
    {
        ...
        if (hasBookingDate &&
            IsWeekend(request.BookingDate!.Value))
        {
            throw new Exception(
                "Room availability is not available on Saturdays and Sundays.");
        }
